...
## News
The official SAM 2.1 has just been released on 30 September, which is not fully compatible with the current SAM2. We are trying to migrate SAM2-UNet to SAM2.1-UNet, stay tuned!
